...
public class Enemy : MonoBehaviour, IPointerClickHandler
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.GetComponent<EnemyPathPoint>() && collision.transform == _target)
            _target = null;
    }
    ...
    private void Death()
    {
        _animator.SetTrigger(AnimatorEnemy.States.Death);
    ...
    private void Patrol()
    {
        ...
        if (_scaner.PathPoint != null)
        {
            Transform tempTarget = _scaner.PathPoint;

            if (_pathPoints.Contains(tempTarget.transform) == false)
